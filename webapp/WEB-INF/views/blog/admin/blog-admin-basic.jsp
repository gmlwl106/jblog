	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath }/${authUser.id }/admin/blogModify" method="post" enctype="multipart/form-data">
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			...
			      			<td><input id="textTitle" type="text" name="blogTitle" value="${blogMap.headerVo.blogTitle }"></td>
			      		</tr>
			      		<tr>
